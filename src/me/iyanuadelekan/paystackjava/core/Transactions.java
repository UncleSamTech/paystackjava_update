...
public class Transactions {
    ...
    public JSONObject initializeTransaction(HashMap<String, Object> queryMap) {
        ...
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_INITIALIZE_TRANSACTION);
    ...
    public JSONObject initializeTransaction(String reference, String amount, String email,
        ...
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_INITIALIZE_TRANSACTION);
        ApiQuery apiQuery = PaystackInstanceManager.getApiQuery();
    ...
    public JSONObject verifyTransaction(String reference) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_VERIFY_TRANSACTION + reference);
    ...
    public JSONObject listTransactions(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_LIST_TRANSACTIONS);
    ...
    public JSONObject fetchTransaction(String id) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_FETCH_TRANSACTION + id);
        return this.apiConnection.connectAndQueryWithGet();
    }
    ...
    public JSONObject chargeAuthorization(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_CHARGE_AUTHORIZATION);
        return this.apiConnection.connectAndQuery(queryMap);
    }
    ...
    public JSONObject chargeToken(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_CHARGE_TOKEN);
        return this.apiConnection.connectAndQuery(queryMap);
    }
    ...
    public JSONObject exportTransactions(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_TRANSACTIONS_EXPORT_TRANSACTIONS);
        return this.apiConnection.connectAndQueryWithGet(queryMap);
    }
