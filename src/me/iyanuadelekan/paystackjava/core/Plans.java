...
public class Plans {
    ...
    public JSONObject createPlan(HashMap<String, Object> queryMap) {
        ...
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_PLANS_CREATE_PLAN);
    ...
    public JSONObject listPlans(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_PLANS_LIST_PLANS);
    ...
    public JSONObject fetchPlan(String idOrPlanCode) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_PLANS_FETCH_PLAN + idOrPlanCode);
    ...
    public JSONObject updatePlan(String idOrPlanCode, HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_PLANS_UPDATE_PLAN + idOrPlanCode);
    ...
    public JSONObject updatePlan(String idOrPlanCode, ApiQuery query) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_PLANS_UPDATE_PLAN.concat(idOrPlanCode));
