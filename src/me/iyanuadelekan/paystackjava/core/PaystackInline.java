...
public class PaystackInline {
    ...
    public JSONObject paystackStandard(HashMap<String, Object> queryMap) {
        ...
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_INLINE_PAYSTACK_STANDARD);
    ...
    public JSONObject verifyTransactions(String reference) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_INLINE_VERIFY_TRANSACTIONS.concat(reference));
    ...
    public JSONObject chargeReturningCustomer(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_INLINE_CHARGE_AUTHORIZATION);
        return this.apiConnection.connectAndQuery(queryMap);
    }
