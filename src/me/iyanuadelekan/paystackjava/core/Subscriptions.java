...
public class Subscriptions {
    ...
    public JSONObject createSubscription(HashMap<String, Object> queryMap) {
        ...
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_SUBSCRIPTIONS_CREATE_SUBSCRIPTION);
    ...
    public JSONObject disableSubscription(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_SUBSCRIPTIONS_DISABLE_SUBSCRIPTION);
        return this.apiConnection.connectAndQuery(queryMap);
    }
    ...
    public JSONObject enableSubscription(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_SUBSCRIPTIONS_ENABLE_SUBSCRIPTION);
        return this.apiConnection.connectAndQuery(queryMap);
    }
    ...
    public JSONObject fetchSubscription(String idOrSubscriptionCode) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_SUBSCRIPTIONS_FETCH_SUBSCRIPTION);
