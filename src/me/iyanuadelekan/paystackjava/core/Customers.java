...
public class Customers {
    ...
    public JSONObject createCustomer(HashMap<String, Object> queryMap) {
        ...
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_CUSTOMERS_CREATE_CUSTOMER);
    ...
    public JSONObject listCustomers(HashMap<String, Object> queryMap) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_CUSTOMERS_LIST_CUSTOMERS);
    ...
    public JSONObject fetchCustomer(String idOrCustomerCode) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_CUSTOMERS_FETCH_CUSTOMER + idOrCustomerCode);
    ...
    public JSONObject updateCustomer(HashMap<String, Object> queryMap, String idOrCustomerCode) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_CUSTOMERS_UPDATE_CUSTOMER + idOrCustomerCode);
    ...
    public JSONObject updateCustomer(String idOrCustomerCode, String email, String firstName, String lastName,
            String phone, Object metadata) {
        //replaced with the PaystackInstanceManager class
        this.apiConnection = PaystackInstanceManager.getApiConnection(Definitions.PAYSTACK_CUSTOMERS_UPDATE_CUSTOMER.concat(idOrCustomerCode));
